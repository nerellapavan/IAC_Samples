...
"#Attaches to the default network interface of the instance aws ec2 --region us-west-2 associate-address --network-interface-id $ENIID --allocation-id $ALLOCATIONID","\n",
